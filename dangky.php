<?php
	...
	if(isset($_POST['dangky'])) {
        ...
        if(mysqli_num_rows($old)>0){
            ...
            $sql_dangky = mysqli_query($conn,"INSERT INTO user(userName,fullName,password,email,phone,adress) 
                    ...
                    <div class="loginform">
                        <form action="" class="login" method="post"> 
                            ...
                            <div class="form-group last mb-3">
                                ...
                                <input type="number" class="form-control" autocomplete="off" required="" name="phone">
                            </div>                      
                            <div class="form-group last mb-3">
                                <label for="diachi">Địa chỉ :</label>
                                <input type="text" class="form-control"autocomplete="off"  required="" name="adress">
                            </div> 

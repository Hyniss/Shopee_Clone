<?php
    ...
    $sql_total_sp = "SELECT * FROM product " ;
    ...
    $sql_lietke_sanpham = "SELECT * FROM product ORDER BY id ASC LIMIT ".$page_item." OFFSET ".$offset."" ;
    ...
    <table class = "table table-bordered" style = "text-align: center;font-size:1.6rem;text-transform: capitalize;">
        ...
        <tbody>   
            <tr style="line-height: 50px;">
                ...
                <td>
                    <a href="modules/quanlysanpham/xuly.php?idsanpham=<?php echo $row['id'] ?>">

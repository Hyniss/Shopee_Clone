<?php
    ...
    $sql_lietke_danhmuc = "SELECT * FROM category ORDER BY numbers ASC" ;
    ...
    <table class = "table table-bordered" style = " text-align: center; font-size:1.6rem">
        ...
        <tbody>   
            <tr>
                ...
                <td>
                    <a href="?action=quanlydanhmuc&query=sua&iddanhmuc=<?php echo $row['id'] ?>">
                        <button class="btn btn-primary">Sửa</button>
                    </a>
                </td>                      
                <td>
                    <a href="modules/quanlydanhmuc/xuly.php?iddanhmuc=<?php echo $row['id'] ?>">
